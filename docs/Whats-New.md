...
````{dropdown} Click to show
  ...
  Description=Edit a variable with specified operation.
  IDOverride=501
  P1Type=Number
  P2Type=Number
  P3Type=Number
  ...
  Description=Generate a random number within specified bounds and store in variable.
  IDOverride=502
  P1Type=Number
  P2Type=Number
  P3Type=Number
  ...
  Description=Print the value of specified variable to screen.
  IDOverride=503
  P1Type=Number
  P4Type=Boolean
  ...
  Description=Perform a binary operation between variables.
  IDOverride=504
  P1Type=Number
  P2Type=Number
  P3Type=Number
  ...
  ; ===== Super Weapon Actions (505-506) =====

  [Action505]
  Name=Fire Super Weapon at specified location [Phobos]
  ...
  [Action506]
  Name=Fire Super Weapon at specified waypoint [Phobos]
  Description=Launch a Super Weapon from [SuperWeaponTypes] list at a specified waypoint. House=-1 means random target that isn't neutral. House=-2 means the first neutral house. House=-3 means random human target.
  IDOverride=506
  P1Type=SuperWeapon
  P2Type=HouseType
  P3Type=Waypoint

  ; ===== MCV & Diplomacy Actions (510, 606-608) =====

  [Action510]
  Name=Toggle MCV Redeployability [Phobos]
  Description=Set MCVRedeploys to the given value.
  IDOverride=510
  P1Type=Boolean
  P2Type=HouseType
  ...
  Description=Edit the hate-value that trigger houses to other houses. -1 works for all houses.
  IDOverride=606
  P1Type=HouseType
  P2Type=Number
  P3Type=Number
  ...
  Description=Clear the hate-value that trigger houses to other houses. -1 works for all houses.
  IDOverride=607
  P1Type=HouseType
  P2Type=HouseType
  ...
  Description=Force an enemy, it will not change with the change of hate-value. -1 will remove the forced enemy, -2 will never have any enemies.
  IDOverride=608
  P1Type=HouseType
  P2Type=HouseType

  ; ===== Banner Display Actions (800-802) =====

  [Action800]
  Name=Display banner and local variable [Phobos]
  Description=Draw banner on screen with local variable value and replace banner with same ID.
  IDOverride=800
  P1Type=Number
  P2Type=Number
  P3Type=Number
  P4Type=Number
  P5Type=LocalVariable

  [Action801]
  Name=Display banner and global variable [Phobos]
  Description=Draw banner on screen with global variable value and replace banner with same ID.
  IDOverride=801
  P1Type=Number
  P2Type=Number
  P3Type=Number
  P4Type=Number
  P5Type=GlobalVariable
...
````{dropdown} Click to show
  ...
  [Event501]
  Name=Local variable is less than  [Phobos]
  Description=Triggers when local variable is less than specified value.
  IDOverride=501
  P1Type=LocalVariable
  P2Type=Number

  [Event502]
  Name=Local variable equals to  [Phobos]
  Description=Triggers when local variable equals specified value.
  IDOverride=502
  P1Type=LocalVariable
  P2Type=Number

  [Event503]
  Name=Local variable is greater than or equals to  [Phobos]
  Description=Triggers when local variable is greater than or equals specified value.
  IDOverride=503
  P1Type=LocalVariable
  P2Type=Number

  [Event504]
  Name=Local variable is less than or equals  [Phobos]
  Description=Triggers when local variable is less than or equals specified value.
  IDOverride=504
  P1Type=LocalVariable
  P2Type=Number

  [Event505]
  Name=Local variable and X is true  [Phobos]
  Description=Triggers when local variable bitwise AND with X is true.
  IDOverride=505
  P1Type=LocalVariable
  P2Type=Number

  ; Global variable comparisons with constants
  [Event506]
  Name=Global variable is greater than  [Phobos]
  Description=Triggers when global variable is greater than specified value.
  IDOverride=506
  P1Type=GlobalVariable
  P2Type=Number

  [Event507]
  Name=Global variable is less than  [Phobos]
  Description=Triggers when global variable is less than specified value.
  IDOverride=507
  P1Type=GlobalVariable
  P2Type=Number

  [Event508]
  Name=Global variable equals to  [Phobos]
  Description=Triggers when global variable equals specified value.
  IDOverride=508
  P1Type=GlobalVariable
  P2Type=Number

  [Event509]
  Name=Global variable is greater than or equals to  [Phobos]
  Description=Triggers when global variable is greater than or equals specified value.
  IDOverride=509
  P1Type=GlobalVariable
  P2Type=Number

  [Event510]
  Name=Global variable is less than or equals to  [Phobos]
  Description=Triggers when global variable is less than or equals specified value.
  IDOverride=510
  P1Type=GlobalVariable
  P2Type=Number

  [Event511]
  Name=Global variable and X is true  [Phobos]
  Description=Triggers when global variable bitwise AND with X is true.
  IDOverride=511
  P1Type=GlobalVariable
  P2Type=Number

  ; Local variable comparisons with local variables
  [Event512]
  Name=Local variable is greater than local variable  [Phobos]
  Description=Triggers when first local variable is greater than second local variable.
  IDOverride=512
  P1Type=LocalVariable
  P2Type=LocalVariable

  [Event513]
  Name=Local variable is less than local variable  [Phobos]
  Description=Triggers when first local variable is less than second local variable.
  IDOverride=513
  P1Type=LocalVariable
  P2Type=LocalVariable

  [Event514]
  Name=Local variable equals to local variable  [Phobos]
  Description=Triggers when first local variable equals second local variable.
  IDOverride=514
  P1Type=LocalVariable
  P2Type=LocalVariable

  [Event515]
  Name=Local variable is greater than or equals to local variable  [Phobos]
  Description=Triggers when first local variable is greater than or equals second local variable.
  IDOverride=515
  P1Type=LocalVariable
  P2Type=LocalVariable

  [Event516]
  Name=Local variable is less than or equals local variable  [Phobos]
  Description=Triggers when first local variable is less than or equals second local variable.
  IDOverride=516
  P1Type=LocalVariable
  P2Type=LocalVariable
  ...
  Description=Triggers when first local variable bitwise AND with second local variable is true.
  IDOverride=517
  P1Type=LocalVariable
  P2Type=LocalVariable

  ; Global variable comparisons with local variables
  [Event518]
  Name=Global variable is greater than local variable  [Phobos]
  ...
  [Event519]
  Name=Global variable is less than local variable  [Phobos]
  ...
  [Event520]
  Name=Global variable equals to local variable  [Phobos]
  Description=Triggers when global variable equals local variable.
  IDOverride=520
  P1Type=GlobalVariable
  P2Type=LocalVariable

  [Event521]
  Name=Global variable is greater than or equals to local variable  [Phobos]
  Description=Triggers when global variable is greater than or equals local variable.
  IDOverride=521
  P1Type=GlobalVariable
  P2Type=LocalVariable

  [Event522]
  Name=Global variable is less than or equals to local variable  [Phobos]
  Description=Triggers when global variable is less than or equals local variable.
  IDOverride=522
  P1Type=GlobalVariable
  P2Type=LocalVariable
  ...
  Description=Triggers when global variable bitwise AND with local variable is true.
  IDOverride=523
  P1Type=GlobalVariable
  P2Type=LocalVariable

  ; Local variable comparisons with global variables
  [Event524]
  Name=Local variable is greater than global variable  [Phobos]
  ...
  [Event525]
  Name=Local variable is less than global variable  [Phobos]
  ...
  [Event526]
  Name=Local variable equals to global variable  [Phobos]
  Description=Triggers when local variable equals global variable.
  IDOverride=526
  P1Type=LocalVariable
  P2Type=GlobalVariable

  [Event527]
  Name=Local variable is greater than or equals to global variable  [Phobos]
  Description=Triggers when local variable is greater than or equals global variable.
  IDOverride=527
  P1Type=LocalVariable
  P2Type=GlobalVariable

  [Event528]
  Name=Local variable is less than or equals global variable  [Phobos]
  Description=Triggers when local variable is less than or equals global variable.
  IDOverride=528
  P1Type=LocalVariable
  P2Type=GlobalVariable
  ...
  Description=Triggers when local variable bitwise AND with global variable is true.
  IDOverride=529
  P1Type=LocalVariable
  P2Type=GlobalVariable

  ; Global variable comparisons with global variables
  [Event530]
  Name=Global variable is greater than global variable  [Phobos]
  Description=Triggers when first global variable is greater than second global variable.
  IDOverride=530
  P1Type=GlobalVariable
  P2Type=GlobalVariable

  [Event531]
  Name=Global variable is less than global variable  [Phobos]
  Description=Triggers when first global variable is less than second global variable.
  IDOverride=531
  P1Type=GlobalVariable
  P2Type=GlobalVariable

  [Event532]
  Name=Global variable equals to global variable  [Phobos]
  Description=Triggers when first global variable equals second global variable.
  IDOverride=532
  P1Type=GlobalVariable
  P2Type=GlobalVariable

  [Event533]
  Name=Global variable is greater than or equals to global variable  [Phobos]
  Description=Triggers when first global variable is greater than or equals second global variable.
  IDOverride=533
  P1Type=GlobalVariable
  P2Type=GlobalVariable

  [Event534]
  Name=Global variable is less than or equals to global variable  [Phobos]
  Description=Triggers when first global variable is less than or equals second global variable.
  IDOverride=534
  P1Type=GlobalVariable
  P2Type=GlobalVariable
  ...
  Description=Triggers when first global variable bitwise AND with second global variable is true.
  IDOverride=535
  P1Type=GlobalVariable
  P2Type=GlobalVariable

  ; ===== Shield & Techno Events (600-606) =====

  [Event600]
  Name=Shield of the attached object is broken  [Phobos]
  Description=Triggers when the shield attached to an object is broken.
  IDOverride=600

  [Event601]
  Name=House owns Techno Type  [Phobos]
  Description=Triggers when specified house owns at least one unit of specified techno type.
  IDOverride=601
  P1Type=HouseType
  P2Type=Techno

  [Event602]
  Name=House doesn't own Techno Type  [Phobos]
  Description=Triggers when specified house doesn't own any units of specified techno type.
  IDOverride=602
  P1Type=HouseType
  P2Type=Techno

  [Event604]
  Name=Techno Type Entered Cell  [Phobos]
  Description=Triggers when a techno of specified type enters a cell.
  IDOverride=604
  P1Type=HouseType
  P2Type=Techno

  [Event605]
  Name=AI Target Type Entered Cell  [Phobos]
  Description=Triggers when an AI target type enters a cell.
  IDOverride=605
  P1Type=HouseType
  P2Type=Number

  [Event606]
  Name=AttachEffect is attaching to a Techno  [Phobos]
  Description=Triggers when an AttachEffect is being attached to a techno.
  IDOverride=606
  P2Type=Number
  ```
...
````{dropdown} Click to show
  ...
  [Script10001]
  Name=Attack nearest once [Phobos]
  Description=Ends when a team member kills the designated target.
  IDOverride=10001

  [Script10002]
  Name=Attack nearest repeat 2 [Phobos]
  Description=Attack nearest repeatedly.
  IDOverride=10002

  [Script10003]
  Name=Attack nearest once 2 [Phobos]
  Description=Ends when a team member kills the designated target.
  IDOverride=10003

  [Script10004]
  Name=Attack nearest repeat 3 [Phobos]
  Description=Picks one random target from the list and attacks repeatedly.
  IDOverride=10004

  [Script10005]
  Name=Attack farthest repeat [Phobos]
  Description=Attack farthest repeatedly.
  IDOverride=10005

  [Script10006]
  Name=Attack farthest once [Phobos]
  Description=Ends when a team member kills the designated target.
  IDOverride=10006

  [Script10007]
  Name=Attack farthest repeat 2 [Phobos]
  Description=Attack farthest repeatedly.
  IDOverride=10007

  [Script10008]
  Name=Attack farthest once 2 [Phobos]
  Description=Ends when a team member kills the designated target.
  IDOverride=10008

  [Script10009]
  Name=Attack farthest repeat 3 [Phobos]
  Description=Picks one random target from the list and attacks repeatedly.
  IDOverride=10009

  [Script10010]
  Name=Attack near high threat repeat [Phobos]
  Description=Attack nearby high-threat targets repeatedly.
  IDOverride=10010

  [Script10011]
  Name=Attack near high threat once [Phobos]
  Description=Ends when a team member kills the designated high-threat target.
  IDOverride=10011

  [Script10012]
  Name=Attack near high threat repeat 2 [Phobos]
  Description=Attack nearby high-threat targets repeatedly.
  IDOverride=10012

  [Script10013]
  Name=Attack near high threat once 2 [Phobos]
  Description=Ends when a team member kills the designated high-threat target.
  IDOverride=10013

  [Script10014]
  Name=Attack far high threat repeat [Phobos]
  Description=Attack distant high-threat targets repeatedly.
  IDOverride=10014

  [Script10015]
  Name=Attack far high threat once [Phobos]
  Description=Ends when a team member kills the designated high-threat target.
  IDOverride=10015

  [Script10016]
  Name=Attack far high threat repeat 2 [Phobos]
  Description=Attack distant high-threat targets repeatedly.
  IDOverride=10016

  [Script10017]
  Name=Attack far high threat once 2 [Phobos]
  Description=Ends when a team member kills the designated high-threat target.
  IDOverride=10017

  [Script10050]
  Name=Move to near high threat enemy [Phobos]
  Description=Move toward the nearest high-threat enemy.
  IDOverride=10050

  [Script10051]
  Name=Move to near high threat enemy 2 [Phobos]
  Description=Move toward the nearest high-threat enemy (variant 2).
  IDOverride=10051

  [Script10052]
  Name=Move to near enemy 2 [Phobos]
  Description=Picks one random target from the selected list and moves toward it.
  IDOverride=10052

  [Script10053]
  Name=Move to near friendly [Phobos]
  Description=Move toward the nearest friendly unit.
  IDOverride=10053

  [Script10054]
  Name=Move to near friendly 2 [Phobos]
  Description=Move toward the nearest friendly unit (variant 2).
  IDOverride=10054

  [Script10055]
  Name=Move to near friendly 3 [Phobos]
  Description=Picks one random friendly target from the selected list and moves toward it.
  IDOverride=10055

  [Script10056]
  Name=Move to far high threat enemy [Phobos]
  Description=Move toward a distant high-threat enemy.
  IDOverride=10056

  [Script10057]
  Name=Move to far high threat enemy 2 [Phobos]
  Description=Move toward a distant high-threat enemy (variant 2).
  IDOverride=10057

  [Script10058]
  Name=Move to far enemy 2 [Phobos]
  Description=Picks one random distant enemy from the selected list and moves toward it.
  IDOverride=10058

  [Script10059]
  Name=Move to far friendly [Phobos]
  Description=Move toward a distant friendly unit.
  IDOverride=10059

  [Script10060]
  Name=Move to far friendly 2 [Phobos]
  Description=Move toward a distant friendly unit (variant 2).
  IDOverride=10060

  [Script10061]
  Name=Move to far friendly 3 [Phobos]
  Description=Picks one random distant friendly target from the selected list and moves toward it.
  IDOverride=10061

  [Script10100]
  Name=Timed Area Guard [Phobos]
  Description=Puts the TaskForce into Area Guard mode for the given units of time.
  IDOverride=10100
  ParamType=Number
  ...
  Description=Waits until all ammo-using units in the TaskForce are fully refilled.
  IDOverride=10101

  [Script10102]
  Name=Regroup Around Team Leader [Phobos]
  Description=Puts the TaskForce into Area Guard mode for the given time around the Team Leader.
  IDOverride=10102
  ParamType=Number
  ParamDescription=Seconds
  ...
  Description=Units capable of being carried enter transports in the same TaskForce.
  IDOverride=10103

  [Script10104]
  Name=Chronoshift to Enemy Base [Phobos]
  Description=Chronoshifts the TaskForce near the enemy base. Parameter is additional distance in cells (can be negative).
  IDOverride=10104
  ParamType=Number
  ...
  Description=Causes upcoming attack actions to wait if no target was found; retries controlled by parameter (0 = infinite).
  IDOverride=12000
  ParamType=Number
  ParamDescription=Retry Count (0=infinite)

  [Script12001]
  Name=Modify Target Distance [Phobos]
  Description=Overrides CloseEnough distance for the next movement/attack action.
  IDOverride=12001
  ParamType=Number
  ParamDescription=Distance Override (Cells)

  [Script12002]
  Name=Set Move Action End Mode [Phobos]
  Description=Sets how the next movement action ends and continues the script.
  IDOverride=12002
  ParamType=Number
  ParamDescription=End Mode

  [Script14000]
  Name=Teams Trigger Weight Reward [Phobos]
  Description=Rewards the AI Trigger weight when the team kills its target.
  IDOverride=14000
  ParamType=Number
  ParamDescription=Weight Reward

  [Script14001]
  Name=Increase AI Trigger Weight [Phobos]
  Description=Increases the current AI Trigger weight within allowed bounds.
  IDOverride=14001
  ParamType=Number
  ParamDescription=Weight Increase

  [Script14002]
  Name=Decrease AI Trigger Weight [Phobos]
  Description=Decreases the current AI Trigger weight within allowed bounds.
  IDOverride=14002
  ParamType=Number
  ParamDescription=Weight Decrease

  [Script14003]
  Name=Unregister Team Success [Phobos]
  Description=The opposite effect of the script action Register Success. The Team failed.
  IDOverride=14003

  [Script16000]
  Name=Start Timed Jump to Same Line [Phobos]
  Description=When the timer ends the current script action ends and starts again the same script action. The timer jump repeats again (infinite loop) until stopped with action 16002 or the team is destroyed.
  IDOverride=16000
  ParamType=Number
  ParamDescription=Seconds

  [Script16001]
  Name=Start Timed Jump to Next Line [Phobos]
  Description=When the timer ends the current script action ends and starts the next one in the script type list.
  IDOverride=16001
  ParamType=Number
  ParamDescription=Seconds

  [Script16002]
  Name=Stop the Timed Jumps [Phobos]
  Description=If the Timed Jumps were activated this action stops the process.
  IDOverride=16002

  [Script16003]
  Name=Randomly Skip Next Action [Phobos]
  Description=When executed this action picks a random value between 1 and 100. If the value is equal or below the parameter then the next action will be skipped. If the parameter is 0 means that the next action will never be skipped and 100 means they always will be skipped.
  IDOverride=16003
  ParamType=Number
  ParamDescription=Skip Probability (0-100)

  [Script16004]
  Name=Pick a Random Script [Phobos]
  Description=When executed this action picks a random Script Type and replaces the current script by the new picked one. The parameter is a 0-based index from the new section AIScriptsList in rulesmd.ini.
  IDOverride=16004
  ParamType=Number
  ...
  Description=Used in a Random Script picked by action 16004. It can jump back to the previous script action and continue in the line after script action 16004.
  IDOverride=16005

  [Script18000]
  Name=Variable 01 [Phobos]
  Description=Values -32768 to 32767.
  IDOverride=18000
  ParamType=Number
  ParamDescription=Value

  [Script18001]
  Name=Variable 02 [Phobos]
  Description=Values -32768 to 32767.
  IDOverride=18001
  ParamType=Number
  ParamDescription=Value
